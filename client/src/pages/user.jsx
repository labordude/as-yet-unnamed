        ...
        <SimpleGrid className="my-4 flex" columns={[2]} spacing="20px">
          <Box
            ...
            <Container className="flex flex-col px-0 items-center">
              ...
              <div>
                <b>Followers:</b> {user_loader.followers}
              </div>
              <div>
                <b>Following:</b> {user_loader.followed}
              </div>
            </Container>
          </Box>
          <Container centerContent>
            <Box
              ...
              <Container>
                <Container>
                  <p>
                    <b>Name:</b> {user_loader.name}
                  </p>
                  <p>
                    <b>Bio:</b> {user_loader.bio}
                  </p>
                  <p>
                    <b>Communities:</b>{" "}
                  </p>
                ...
                <Container className="mt-8">
                  <p>
                    <b>Total Reviews:</b> {user_loader.reviews.length}
                  </p>
                  <p>
                    <b>Total Games:</b> {user_loader.reviews.length}
                  </p>
                  <p>
                    <b>Total Ratings:</b> {user_loader.reviews.length}{" "}
                  </p>
                </Container>
